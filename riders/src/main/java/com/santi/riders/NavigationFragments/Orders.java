package com.santi.riders.NavigationFragments;
...
import com.santi.mylibrary.Utilities;
import com.santi.riders.R;
        ...
        view.findViewById(R.id.button_confirm).setOnClickListener(e ->{
            if(!available){
                Toast.makeText(getContext(),
                        "You have already accepted this order!",Toast.LENGTH_LONG).show();
            }else {

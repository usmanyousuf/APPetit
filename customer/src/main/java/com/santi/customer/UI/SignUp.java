...
import com.santi.mylibrary.User;
...
import static com.santi.mylibrary.SharedClass.Address;
import static com.santi.mylibrary.SharedClass.CUSTOMER_PATH;
import static com.santi.mylibrary.SharedClass.CameraOpen;
import static com.santi.mylibrary.SharedClass.Mail;
import static com.santi.mylibrary.SharedClass.Name;
import static com.santi.mylibrary.SharedClass.PERMISSION_GALLERY_REQUEST;
import static com.santi.mylibrary.SharedClass.Phone;
import static com.santi.mylibrary.SharedClass.Photo;
...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyCW6n5KH-KNDDUGVzP09dr4vtqhIw8cjBc");
        ...
        if(currentPhotoPath != null) {
            ...
            ref.putFile(url).continueWithTask(task -> {
                ...
                if (task.isSuccessful()){
                    ...
                    new_user.put("customer_info",new User("lucf9r", name, surname
            ...
            new_user.put("customer_info",new User("customer1", name, surname
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.santi.customer.fileprovider",
                        photoFile);
